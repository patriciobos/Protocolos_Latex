...
\begin{minipage}[c]{1.0\linewidth}
\begin{figure}[H]
	\includegraphics[width=1\textwidth]{./imagenes/txfifo.jpg}
		\end{figure}	
\end{minipage}
\end{frame}
...
\begin{minipage}[c]{1.0\linewidth}
\begin{figure}[H]
	\includegraphics[width=1\textwidth]{./imagenes/filtering.jpg}
		\end{figure}	
\end{minipage}
\end{frame}
...
\begin{minipage}[c]{1.0\linewidth}
\begin{figure}[H]
	\includegraphics[width=1\textwidth]{./imagenes/matching.jpg}
		\end{figure}	
\end{minipage}
\end{frame}
\section{Mote}
